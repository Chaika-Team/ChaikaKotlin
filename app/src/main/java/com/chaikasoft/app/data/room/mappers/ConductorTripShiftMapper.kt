...
fun Int.toTripShiftStatusDomain(): TripShiftStatusDomain = TripShiftStatusDomain.withCode(this)

/** Преобразование TripShiftStatusDomain → Int */
fun TripShiftStatusDomain.toInt(): Int = this.code

/** Entity → Domain */
fun ConductorTripShiftWithStations.toDomain(): ConductorTripShiftDomain = ConductorTripShiftDomain(
    trip = TripDomain(
        uuid = shift.uuid,

 ...
 * @param soldCardQuantity Количество проданных по карте единиц продукта.
...
@DatabaseView(
    ...
    value = """
        SELECT 
            ...
            SUM(CASE WHEN cart_operations.operation_type = 2 THEN -cart_items.impact ELSE 0 END) AS sold_card_quantity,
...
data class FastReportView(
    ...
    @ColumnInfo(name = "sold_card_quantity") val soldCardQuantity: Int,
